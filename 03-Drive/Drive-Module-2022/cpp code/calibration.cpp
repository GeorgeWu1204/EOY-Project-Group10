...
// these pins can change:

#define PIN_MOUSECAM_RESET     22 // D3, this pin was changed from 35
#define PIN_MOUSECAM_CS        5 // D7, this pin was not changed
...
void loop()
{
  ...
  total_x = total_x1/100;
  total_y = total_y1/100;
